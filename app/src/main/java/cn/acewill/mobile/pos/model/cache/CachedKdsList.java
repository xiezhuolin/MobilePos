 ...
 */
@com.raizlabs.android.dbflow.annotation.Table(name="cached_kds_list",database =AppDatabase.class)
@ModelContainer
public class CachedKdsList extends BaseModel {
    public static Gson gson = new Gson();

    public CachedKdsList() {
    }

    public CachedKdsList(KDS payment) {
    ...
    public KDS toKDS() {
        return gson.fromJson(this.jsonObject, KDS.class);
    }
}
