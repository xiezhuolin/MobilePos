...
public class CreateImage {
     ...
     * @return
     */
    public static Bitmap creatQRImage(String url, Bitmap logoBm,
     ...
     * @param st
     */
//    public static Bitmap convertStringToIcon(final String st) {
//        // OutputStream out;
//        final Bitmap[] bitmap = {null};
//        try {
//            final ImageLoader imageLoader = MyApplication.getInstance().getImageLoader();
//            new Thread(new Runnable() {
//                @Override
//                public void run() {
//                    bitmap[0] = imageLoader.loadImageSync(st);
//                }
//            }).start();//启动线程
//            try {
