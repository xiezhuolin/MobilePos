 ...
 */
public class NetOrderInfoAty extends BaseActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        myApplication.addPage(NetOrderInfoAty.this);
    ...
    public static Dialog revokeInvoiceDialog(final Context context, final DialogTCallback dialogTCallback) {
        ...
        final Dialog dialog = DialogUtil.createDialog(context, R.layout.dialog_revoke_invoice, 9, 5);
