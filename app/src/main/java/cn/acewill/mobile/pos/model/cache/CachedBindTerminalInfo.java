...
@com.raizlabs.android.dbflow.annotation.Table(name="cached_bind_terminal_info",database =AppDatabase.class)
@ModelContainer
public class CachedBindTerminalInfo extends BaseModel {
    public static Gson gson = new Gson();

    public CachedBindTerminalInfo() {
    }

    public CachedBindTerminalInfo(TerminalInfo dish) {
