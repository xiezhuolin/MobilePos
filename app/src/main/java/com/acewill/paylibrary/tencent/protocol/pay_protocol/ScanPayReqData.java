package com.acewill.paylibrary.tencent.protocol.pay_protocol;
...
import com.acewill.paylibrary.tencent.common.RandomStringGenerator;
...
//			String goodsTag, String sub_mch_id) {
//		this(authCode, body, attach, outTradeNo, totalFee, deviceInfo,
//				spBillCreateIP, timeStart, timeExpire, goodsTag);
//
//		this.setSub_mch_id(sub_mch_id);
//	}
	 ...
	 *            商品标记，微信平台配置的商品标记，用于优惠券或者满减使用
	 */
	public ScanPayReqData(String body, String attachment, String outTradeNo,
			int totalFee, String deviceInfo, String spBillCreateIP,
			String timeStart, String timeExpire, String goodsTag,
			String notify_url, String trade_type, String product_id,
			String sub_mch_id) {
//		setSdk_version(Configure.getSdkVersion());
		setSub_mch_id(sub_mch_id);
		// 微信分配的公众号ID（开通公众号之后可以获取到）
