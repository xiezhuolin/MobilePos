package com.acewill.paylibrary.alipay.util;

import com.acewill.paylibrary.alipay.config.AlipayConfig;
import com.acewill.paylibrary.alipay.sign.MD5;
...
public class AlipaySubmit {
    ...
    public static String buildRequest(Map<String, String> sParaTemp, String strMethod, String strButtonName) {
        ...
        sbHtml.append("<form id=\"alipaysubmit\" label=\"alipaysubmit\" action=\"" + ALIPAY_GATEWAY_NEW
        ...
        for (int i = 0; i < keys.size(); i++) {
            ...
            sbHtml.append("<input ptid=\"hidden\" label=\"" + name + "\" value=\"" + value + "\"/>");
        }

        //submit按钮控件请不要含有name属性
        sbHtml.append("<input ptid=\"submit\" value=\"" + strButtonName + "\" style=\"display:none;\"></form>");
    ...
    public static String buildRequest(Map<String, String> sParaTemp, String strMethod, String strButtonName, String strParaFileName) {
        ...
        sbHtml.append("<form id=\"alipaysubmit\" label=\"alipaysubmit\"  enctype=\"multipart/form-data\" action=\"" + ALIPAY_GATEWAY_NEW
                      + "_input_charset=" + AlipayConfig.input_charset + "\" method=\"" + strMethod
                      + "\">");
        ...
        sbHtml.append("<input ptid=\"file\" label=\"" + strParaFileName + "\" />");
