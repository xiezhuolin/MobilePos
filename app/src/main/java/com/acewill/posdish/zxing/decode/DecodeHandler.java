...
package com.acewill.posdish.zxing.decode;
...
//		if (ScanActivity.mScreenState == ScanActivity.VERTICAL) {
//			rotatedData = data;
//		} else if (ScanActivity.mScreenState == ScanActivity.HORIZONTAL) {
			try {
